...
print(F"Memory size of x: {(x.element_size() * x.nelement() / 1024**2):0.2f} MB for sequence length {SEQUENCE_LENGTH}")
print(F"Memory size of adj: {(adj.element_size() * adj.nelement() / 1024**2):0.2f} MB")
